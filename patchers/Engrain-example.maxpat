...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 327.0, 568.0, 560.0, 151.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 294.0, 846.0, 65.0, 22.0 ],
					"text" : "mc.dup~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 248.5, 573.0, 99.0, 22.0 ],
					"text" : "mc.mixdown~ 64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 307.0, 743.0, 204.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 222.0, 685.0, 45.0, 22.0 ],
					"text" : "adc~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.5, 97.0, 112.0, 23.0 ],
					"text" : "pan-dur-thresh (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 670.5, 122.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 500 ],
							"parameter_initial_enable" : 1,
							"parameter_invisible" : 1,
							"parameter_longname" : "pan-dur-thresh",
							"parameter_shortname" : "pan-dur-thresh",
							"parameter_type" : 3
						}

					}
,
					"varname" : "pan-dur-thresh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.5, 153.0, 104.0, 22.0 ],
					"text" : "pan-dur-thresh $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 469.0, 209.0, 33.0 ],
					"text" : "pan consumes a lot of CPU with 16ch\n* without pan it is also ok"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 90.0, 615.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.5, 62.0, 110.0, 22.0 ],
					"text" : "reverse-random $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 900.5, 35.5, 78.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
							"parameter_longname" : "reverse-random",
							"parameter_mmax" : 1,
							"parameter_shortname" : "reverse-random",
							"parameter_type" : 2
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 782.0, 62.0, 100.0, 22.0 ],
					"text" : "reverse-on-off $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 782.0, 35.5, 78.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
							"parameter_longname" : "reverse-on-off",
							"parameter_mmax" : 1,
							"parameter_shortname" : "reverse-on-off",
							"parameter_type" : 2
						}
...
, 			{
				"box" : 				{
					...
					"orientation" : 2,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 420.0, 540.0, 248.0, 161.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 90.0, 540.0, 92.0, 22.0 ],
					"text" : "mc.mixdown~ 2"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 680.0, 180.0, 99.5, 180.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-24" : [ "reverse-on-off", "reverse-on-off", 0 ],
			"obj-27" : [ "reverse-random", "reverse-random", 0 ],
			...
			"obj-7" : [ "pan-dur-thresh", "pan-dur-thresh", 0 ],
